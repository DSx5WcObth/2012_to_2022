...
# Supplementary
#### Figure 3. Maps of all examined foodstuffs reported during April 2012–December 2020
```{r}
...
#### Figure 4. Maps of all examined general foodstuffs reported during April 2012–December 2020
#### Figure 5. Maps of all examined milk/infant foodstuffs reported during April 2012–December 2020
#### Figure 6. Maps of all examined drinking water reported during April 2012–December 2020
```{r}
# Prefectures are indicated by borders. Prefectures having no foods reported were left clear. The location of FDNPS is indicated by an orange dot. All data reported in the database were included in the analysis.
# 
# Fukushima Daiichi place
...
# Fig9_Total <- data_2012_2020_total_ %>%
#   filter(Item!="Cattle meat" & !str_detect(その他,"全頭検査")) %>%
#   filter(Item!="Cattle meat" & !str_detect(その他,"全島検査")) %>%
#   filter(Market=="Market products") %>%
#   count(Fiscal_Year) %>%
#   mutate("Market_NonMarket"="Market") %>%
#   rbind(
#     data_2012_2020_total_ %>%
#       filter(Item!="Cattle meat" & !str_detect(その他,"全頭検査")) %>%
#       filter(Item!="Cattle meat" & !str_detect(その他,"全島検査")) %>%
#       filter(Market!="Market products") %>%
#       count(Fiscal_Year) %>%
#       mutate("Market_NonMarket"="NonMarket")
#       )
